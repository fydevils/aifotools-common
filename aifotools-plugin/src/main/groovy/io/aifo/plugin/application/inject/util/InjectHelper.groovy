...
public class InjectHelper {
     ...
     * @param path
     */
    static void initInject(io.aifo.plugin.application.inject.InjectInfo injectInfo, String path) {
     ...
     * @return
     */
    static String getInjectFieldStr(io.aifo.plugin.application.inject.InjectInfo injectInfo) {
